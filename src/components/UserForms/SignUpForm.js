            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  helperText={firstName !== "" && !firstName.match(USERNAME_REGEX) ? 'Provide valid name, please.' : ''}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  helperText={lastName !== "" && !lastName.match(USERNAME_REGEX) ? 'Provide valid name, please.' : ''}
                  sx={{background:"#ffebee", borderRadius:1}}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={email !== "" && !email.match(EMAIL_REGEX) ? 'Provide valid email, please.' : ''}
                  sx={{background:"#ffebee", borderRadius:1}}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={password !== "" && !password.match(PWD_REGEX) ? 'Password must contain letters, numbers and special symbols. Should be at least 8 characters long.' : ''}
                  sx={{background:"#ffebee", borderRadius:1}}
                />
              </Grid>
            </Grid>
