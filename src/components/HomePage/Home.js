      ...
      <>
        ...
        >
          ...
          <Typography 
            component="div" 
            align="center" 
            sx={{ flexGrow: 1, color: 'aliceblue', position: 'absolute', top: '17%', left: '130px', fontSize: '32px'}}
            >
              <span style={{fontSize: "70px", fontStyle: "italic"}}>Sport Maps</span><br></br><br></br>
              це додаток, який надасть Вам змогу<br></br>
              швидко знаходити спортивні об'єкти,<br></br>
              a для постачальників спортивних послуг -<br></br>
          ...
          <Button 
            ...
            variant='contained'
            sx={{flexGrow: 1, backgroundColor: 'crimson', position: 'absolute', top: '65%', left: '330px', opacity: '0.95',
                 fontFamily: "'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif", fontSize: '20px', fontWeight: 'bold', borderRadius: '30px'}}
            >
              Завантажити додаток
          </Button>
        </Container>
          ...
          >
            ...
            >
              ...
              <Typography
                component="div" 
                align="center" 
                sx={{ flexGrow: 1, color: 'aliceblue', fontSize: '20px', mt: '25px'}}
              >
                <span style={{fontSize: "28px", fontWeight: "bold"}}>Пошук</span><br></br>
            ...
            >
              ...
              <Typography
                ...
                sx={{ flexGrow: 1, color: 'aliceblue', fontSize: '20px', mt: '25px'}}
              >
                <span style={{fontSize: "28px", fontWeight: "bold"}}>Комунікація</span><br></br>
                Знайомство і спілкування<br></br>
                з однодумцями
              </Typography>
            </Container>
            <Container
            ...
            >
              ...
              <Typography
                ...
                sx={{ flexGrow: 1, color: 'aliceblue', fontSize: '20px', mt: '25px'}}
              >
                <span style={{fontSize: "28px", fontWeight: "bold"}}>Заробіток</span><br></br>
            ...
            >
              ...
              <Typography
                ...
                sx={{ flexGrow: 1, color: 'aliceblue', fontSize: '20px', mt: '25px'}}
              >
                <span style={{fontSize: "28px", fontWeight: "bold"}}>Послуги</span><br></br>
        ...
        >
          ...
          >
            <span style={{fontSize: '35px'}}>Наші партнери</span><br></br>
          ...
          >
            <Container
              sx={{width: "400px", marginLeft: "150px"}}
            >
              <img src={PowerFitness} alt="PowerFitness" height="250px" width="250px"></img>
              <Typography
            ...
            <Container
              sx={{width: "400px"}}
            >
              <img src={GymTrainer} alt="GymTrainer" height="250px" width="350px"></img>
              <Typography
                fontFamily="sans-serif"
                color="aliceblue"
                textAlign="left"
            ...
            <Container
              sx={{width: '620px', marginRight: '50px'}}
            >
              ...
              >
                ...
                <span style={{fontSize: '16px', lineHeight: '23px'}}>
                  ...
                  індивідуальних результатів гравців у п'яти основних американських видах<br></br> 
                  спорту (MLB, NHL, NFL, NBA і PGA), футболі Прем'єр-ліги і Ліги чемпіонів<br></br> 
                  УЄФА, автоперегонах NASCAR, Канадській футбольній лізі, XFL, змішаних<br></br> 
                  єдиноборствах (MMA), тенісі, рестлінгу All Elite Wrestling (AEW), і WWE.
                </span>
              </Typography>
            </Container>
          </Container>
        ...
        >
          ...
          <Typography
            ...
            sx={{lineHeight: '0.7cm'}}
          >
            <span style={{fontSize: '20px', fontWeight: 'bold'}}>Адреса</span><br></br>
          ...
          >
            ...
            <Container
              sx={{width: "320px", justifyContent: "space-around", alignItems: "flex-start", display: "flex", fontSize: '18px'}}
            >
              <Container 
                align="left"
                sx={{width: "300px"}}
          ...
          >
            <Typography
              ...
              sx={{lineHeight: '0.7cm'}}
            >
              <span style={{fontSize: '20px', fontWeight: 'bold'}}>Зворотній зв'язок</span><br></br>
              +38 (000)-000-00-00<br></br>
              sportmaps@gmail.com
            </Typography>
            <Container
              sx={{justifyContent: "space-around", alignItems: "flex-start", display: "flex", width: "200px", mt:'10px'}}
            >
              <Avatar
