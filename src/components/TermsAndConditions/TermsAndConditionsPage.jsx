...
export default function TermsAndConditionsPage() {
    return <main>
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to SportMaps, accessible from <a
                    href="https://sport-maps.com/">https://sport-maps.com/</a></p>
            </li>
            <li>
        ...
        <p>Without limiting the foregoing, neither the Company nor any of the company&apos;s provider makes any
            ...
            from or on behalf of the Company are free of viruses, scripts, trojan horses, worms, malware, time{""}bombs
        ...
        <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under
            ...
            any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
        ...
        <ul>
            <li>By email: galaxy.vd123@gmail.com</li>
        </ul>
    </main>
}
